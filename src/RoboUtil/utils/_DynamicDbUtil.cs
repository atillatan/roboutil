...
//        {
//            return Utils.DynamicMapper.Map<T>(Get(connection, commandText, args));
//        }

//        public static List<T> List<T>(SqlConnection connection, string commandText, params object[] args)
//        {
//            return Utils.DynamicMapper.ToMap<T>(List(connection, commandText, args));
//        }
...
//        {
//            return Utils.DynamicMapper.ToMap<T>(List(connection, commandText, pageIndex, PageCount, args));
//        }
