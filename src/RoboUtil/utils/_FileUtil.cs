...
//        {
//            if (!_FileUtil.isFolderPath(path))
//            {
...
//        {
//            _FileUtil.Update(path, fileText, true);
//        }
...
//            return _FileUtil.isExist(path) ? path
//                : _FileUtil.isExist(currentDir + path) ? currentDir + path
//                    : _FileUtil.isExist(currentDir + "\\" + path) ? currentDir + "\\" + path
//                        : _FileUtil.isExist(currentDir + "/" + path) ? currentDir + "/" + path
//                            : _FileUtil.isExist("..\\" + path) ? "..\\" + path
//                                : _FileUtil.isExist("../" + path) ? "../" + path : path;
//        }
